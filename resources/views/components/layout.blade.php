...
<html lang="en">
  ...
  <body>
    ...
    <main class="container">
      <nav>
        <ul>
          <li><a href="#" class="secondary" data-tooltip="Article précédent"><--</a></li>
        </ul>
        <ul>
          <a href="{{ route("home") }}">
              <li>      
                  ...
                  <div>
                    <a href="https://github.com/CamiJi" data-tooltip="Icon designed by ChatGPT">
                    ...
                    <a href="https://mobile.twitter.com/camWebDevParis" data-tooltip="Icon designed by ChatGPT">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    ...
                    <a href="https://www.linkedin.com/in/camille-aubert-27760a56/" data-tooltip="Icon designed by ChatGPT">
        ...
        <ul>
          <li><a href="#" class="secondary" data-tooltip="Article suivant">--></a></li>
        </ul>
      </nav>
